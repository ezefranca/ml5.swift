...
struct ML5ValidationTests {
    ...
    func localizedErrors() {
        let errors: [ML5Error] = [
            ...
            .invalidModelArchive(reason: "bad archive"),
            .modelPersistenceFailed(path: "/model", message: "failed"),
            .coreMLExportFailed(reason: "unsupported model"),
            .invalidNeuroevolutionConfiguration(reason: "bad mutation"),
            .incompatibleBrainTopologies,
            .invalidModelDigest("bad"),
            .modelIntegrityMismatch(expected: "expected", actual: "actual"),
            .invalidModelSource(reason: "bad source"),
            .modelResourceFailed(location: "/model", message: "failed"),
            .modelCacheFailed(path: "/cache", message: "failed"),
            .invalidVisionConfiguration(reason: "bad limit"),
            .visionRequestFailed(message: "failed"),
            .unsupportedVisionResult(reason: "wrong observation"),
            .trainingAcceleratorUnavailable(reason: "no device"),
            .invalidTrainingCheckpoint(reason: "bad checkpoint"),
            ...
            .invalidConfidence(2),
            .invalidClassificationScores(reason: "bad probabilities"),
            .invalidRegressionValue(.infinity),
            .invalidRegressionVector(reason: "bad dimensions"),
            .invalidEvaluation(reason: "bad samples"),
